...
import org.json.JSONException;/*The instance of this import java.io.IOException;
import java.net.MalformedURLException;

class is called by "MainActivty",to get the time taken reach the destination from Google Distance Matrix API in background.
